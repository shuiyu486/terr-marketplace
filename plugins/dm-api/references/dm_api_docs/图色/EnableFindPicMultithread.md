...
**签名:** `long EnableFindPicMultithread(enable)`

**描述:** 当执行FindPicXXX系列接口时,是否在条件满足下(查找的图片大于等于4,这个值可以根据[SetFindPicMultithreadCount](SetFindPicMultithreadCount.htm)来修改),开启多线程查找。 默认打开.
