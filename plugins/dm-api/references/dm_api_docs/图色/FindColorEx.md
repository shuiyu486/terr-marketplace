...
**签名:** `string FindColorEx(x1, y1, x2, y2, color, sim, dir)`

**描述:** 查找指定区域内的所有颜色,颜色格式"RRGGBB-DRDGDB",注意,和按键的颜色格式相反
...
| x2 | int | 区域的右下X坐标 |
| y2 | int | 区域的右下Y坐标 |
| color | str | 颜色 格式为"RRGGBB-DRDGDB" 比如"aabbcc-000000|123456-202020".也可以支持反色模式. 前面加@即可. 比如"@123456-000000|aabbcc-202020". 具体可以看下放注释.注意，这里只支持RGB颜色. |
