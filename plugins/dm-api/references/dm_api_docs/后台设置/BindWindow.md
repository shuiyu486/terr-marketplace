...
**签名:** `long BindWindow(hwnd,display,mouse,keypad,mode)`

**描述:** 绑定指定的窗口,并指定这个窗口的屏幕颜色获取方式,鼠标仿真模式,键盘仿真模式,以及模式设定,高级用户可以参考[BindWindowEx](BindWindowEx.htm)更加灵活强大.
