...
$tplContent = [System.Text.Encoding]::UTF8.GetString([System.IO.File]::ReadAllBytes($tplPath)) -replace '__USERNAME__', $env:USERNAME
...
[System.IO.File]::WriteAllText($localPath, $merged, [System.Text.Encoding]::UTF8)
```
